<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"../themes/default/index\index.html";i:1488248934;s:27:"../themes/default/base.html";i:1488249008;}*/ ?>
<!DOCTYPE html>
    ...
    <div id="sequence">
        <ul class="sequence-canvas">
            ...
            <li class="bg4">
                ...
                <!-- Slide Image -->
                <img class="slide-img" src="__STATIC__/images/homepage-slider/slide1.png" alt="Slide 1" />
            </li>
            <!-- End Slide 1 -->
            <!-- Slide 2 -->
            <li class="bg3">
                ...
                <!-- Slide Image -->
                <img class="slide-img" src="__STATIC__/images/homepage-slider/slide2.png" alt="Slide 2" />
            </li>
            <!-- End Slide 2 -->
            <!-- Slide 3 -->
            <li class="bg1">
                ...
                <!-- Slide Image -->
                <img class="slide-img" src="__STATIC__/images/homepage-slider/slide3.png" alt="Slide 3" />
            </li>
            <!-- End Slide 3 -->
        </ul>
...
<!-- Press Coverage --><div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >企业网站模板</a></div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="service-wrapper">
                    <img src="__STATIC__/images/service-icon/diamond.png" alt="Service 1">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-wrapper">
                    <img src="__STATIC__/images/service-icon/ruler.png" alt="Service 2">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="service-wrapper">
                    <img src="__STATIC__/images/service-icon/box.png" alt="Service 3">
        ...
        <div class="row">
            ...
            <div class="testimonial col-md-4 col-sm-6">
                ...
                <div class="author-photo">
                    <img src="__STATIC__/images/user1.jpg" alt="Author 1">
                </div>
            ...
            <div class="testimonial col-md-4 col-sm-6">
                <div class="author-photo">
                    <img src="__STATIC__/images/user5.jpg" alt="Author 2">
                </div>
                <div class="testimonial-bubble">
                    <blockquote>
                        <p class="quote">
            ...
            <div class="testimonial col-md-4 col-sm-6">
                <div class="author-photo">
                    <img src="__STATIC__/images/user2.jpg" alt="Author 3">
                </div>
                <div class="testimonial-bubble">
                    <blockquote>
                        <p class="quote">
...
<div class="section">
    <div class="container">
        ...
        <div class="clients-logo-wrapper text-center row">
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/canon.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/cisco.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/dell.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/ea.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/ebay.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/facebook.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/google.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/hp.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/microsoft.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/mysql.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/sony.png" alt="Client Name"></a></div>
            <div class="col-lg-1 col-md-1 col-sm-3 col-xs-6"><a href="#"><img src="__STATIC__/images/logos/yahoo.png" alt="Client Name"></a></div>
        </div>
    </div>
</div>
<!-- End Our Clients -->
