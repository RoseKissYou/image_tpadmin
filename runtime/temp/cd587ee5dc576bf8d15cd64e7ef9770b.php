<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"../application/admin/admin_themes/blog\index.html";i:1489639039;s:43:"../application/admin/admin_themes/base.html";i:1489639039;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">文案管理</li>
            <li class=""><a href="<?php echo url('admin/blog/add'); ?>">添加文案</a></li>
        </ul>
        <div class="layui-tab-content">

            <form class="layui-form layui-form-pane" action="<?php echo url('admin/blog/index'); ?>" method="get">
