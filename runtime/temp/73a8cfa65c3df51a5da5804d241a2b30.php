<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"../application/admin/admin_themes/photo\add.html";i:1489663889;s:43:"../application/admin/admin_themes/base.html";i:1489639039;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form form-container" action="<?php echo url('admin/photo/save'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="author" value="" placeholder="（选填）请输入模特" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block"  style="margin-bottom: 17px;">
                            <input type="text" name="width" value="" id="width" class="layui-input layui-input-inline">
                            <label style="width:20px;left: -20px;" class="layui-form-label">高</label>
                            <input style="left: -20px;" type="text" name="height" value="" id="height" class="layui-input layui-input-inline">
                        </div>
