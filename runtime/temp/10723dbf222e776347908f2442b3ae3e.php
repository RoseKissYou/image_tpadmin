<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"../application/admin/admin_themes/photo\index.html";i:1489665367;s:43:"../application/admin/admin_themes/base.html";i:1489639039;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/photo/add'); ?>">添加图片</a></li>
        </ul>
                   ...
                   <div class="layui-tab-item layui-show">
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <td><?php echo $vo['status']==1 ? '不显示' : '显示'; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td>
                                <a href="<?php echo url('admin/photo/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                <a href="<?php echo url('admin/photo/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
