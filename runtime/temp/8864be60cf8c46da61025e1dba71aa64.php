<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"../themes/default/blog\index.html";i:1488248934;s:27:"../themes/default/base.html";i:1488249008;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                    <h2>tp5 测试博客系统</h2>
                    <p><span>Created with <i class="sl-icon-heart"></i>  <a href="<?php echo url('index/blog/add'); ?>">添加博客</a></span></p>
                </div>
            </div>
            ...
            <div class="blog-inner">
                ...
                <a href="<?php echo url('index/blog/detail',['id'=>$result['id']]); ?>"><img style="margin: auto;" class="img-responsive" src="<?php echo $result['thumb']; ?>" alt="Blog"></a>
                <div class="desc">
                    <h3><?php echo $result['title']; ?></h3>
                    <p><?php echo $result['introduction']; ?></p>
                    <p><a href="<?php echo url('index/blog/detail',['id'=>$result['id']]); ?>" class="btn btn-primary btn-outline with-arrow">阅读全文<i class="icon-arrow-right"></i></a></p>
                </div>
            </div>
