<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"../application/photo/view/default/index\index.html";i:1489490385;s:43:"../application/photo/view/default/base.html";i:1489490265;}*/ ?>
    ...
    <div class="wrap">
        <div id="main" role="main">
            <ul id="tiles">
                ...
                <li onclick="location.href='<?php echo url('photo/index/detail',['id'=>$result['id']]); ?>';">
                    <img style="width:300px;height:auto;" src="<?php echo $result['thumb']; ?>" >
                    <div class="post-info">
                        <div class="post-basic-info">
                            <h3><a href="<?php echo url('index/index/detail',['id'=>$result['id']]); ?>"><?php echo $result['title']; ?></a></h3>
                            <span><a href="<?php echo url('index/index/detail',['id'=>$result['id']]); ?>"><label>
                            </label><?php echo $result['title']; ?></a></span>
