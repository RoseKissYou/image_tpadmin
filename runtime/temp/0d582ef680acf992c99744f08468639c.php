<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:31:"../admin_themes/blog\index.html";i:1488186707;s:25:"../admin_themes/base.html";i:1483610894;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">Blog管理</li>
            <li class=""><a href="<?php echo url('admin/blog/add'); ?>">添加Blog</a></li>
        </ul>
