<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"../application/admin/admin_themes/photo\edit.html";i:1489662817;s:43:"../application/admin/admin_themes/base.html";i:1489639039;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="__CSS__/uploader.css">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/photo/index'); ?>">图片管理</a></li>
            <li class="layui-this">添加图片</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form form-container" action="<?php echo url('admin/photo/update',['id'=>$article['id']]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="author" value="<?php echo $article['author']; ?>" placeholder="（选填）请输入模特" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block"  style="margin-bottom: 17px;">
                            <input type="text" name="width" value="<?php echo $article['width']; ?>" id="width" class="layui-input layui-input-inline">
                            <label style="width:20px;left: -20px;" class="layui-form-label">高</label>
                            <input style="left: -20px;" type="text" name="height" value="<?php echo $article['height']; ?>" id="height" class="layui-input layui-input-inline">
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="create_time" value="<?php echo date('Y-m-d H:i:s'); ?>" class="layui-input datetime">
                            </div>
                        </div>
                        <div class="layui-form-item">
