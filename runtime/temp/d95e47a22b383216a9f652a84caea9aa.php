<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"../themes/default/blog\detail.html";i:1488164945;s:27:"../themes/default/base.html";i:1488159545;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                    <h2>tp5 测试博客系统</h2>
                    <p><span>Created with <i class="sl-icon-heart"></i> 作者 <a href="https://github.com/xiayulei/think_admin">github</a></span></p>
                </div>
            </div>
            ...
            <div class="blog-inner">
                <img style="margin: auto;" class="img-responsive" src="<?php echo $result['thumb']; ?>" alt="Blog">
                <div class="desc">
