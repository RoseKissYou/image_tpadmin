<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"../application/admin/admin_themes/blog\add.html";i:1488194107;s:43:"../application/admin/admin_themes/base.html";i:1483610894;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/blog/index'); ?>">文章管理</a></li>
            <li class="layui-this">添加文章</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form form-container" action="<?php echo url('admin/Blog/add'); ?>" method="post">
